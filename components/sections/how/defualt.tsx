...
export default function How() {
	const { 
		howWeDoItTitle,
		howWeDoItHeading1, howWeDoItHeading2, howWeDoItHeading3, 
		howWeDoItHeading4, howWeDoItHeading5, howWeDoItHeading6,
		howWeDoItDescription1, howWeDoItDescription2, howWeDoItDescription3,
		howWeDoItDescription4, howWeDoItDescription5, howWeDoItDescription6,
  ...
  return (
		...
		<div className="mx-auto flex flex-col gap-12">
			...
			<Horizontal events={howWeDoItSections}></Horizontal>
